...
$PAGE->set_url('/mod/elediachecklist/index.php', array('id' => $course->id));
...
$event = \mod_elediachecklist\event\course_module_instance_list_viewed::create($params);
...
if (!$checklists = get_all_instances_in_course('elediachecklist', $course)) {
...
$context = context_course::instance($course->id);
$canupdateown = has_capability('mod/elediachecklist:updateown', $context);
if ($canupdateown) {
