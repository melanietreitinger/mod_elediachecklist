...
use mod_elediachecklist\local\checklist_check;
use mod_elediachecklist\local\checklist_comment;
use mod_elediachecklist\local\checklist_item;
use mod_elediachecklist\local\output_status;
...
class elediachecklist_class {
    ...
    /** @var bool|int[] */
    protected $groupings;
    /** @var mod_elediachecklist_renderer */
    protected $output;

    protected $myExamId = -1;

    protected $globalLayout = "<div class='container'>
	<div class='row'>
		<div class='col-md-8 col-xl-3 offset-xl-0'>
			<div class='col' style='background-color: lightgray; height: 102%'>
			    <div id='examList' style='display: none'>{EXAM_LIST}</div>
			    <div id='checkListId' style='display: none'>{elediachecklist_ID}</div>
				...
				<div class='col-12'>
					<input type='text' id='dozent' readonly disabled/>
				</div>
				<div class='col-12' style='margin-top:10px'>
					<b>Fachbereich:</b>
				</div>
				<div class='col-12'>
					<input type='text' id='fachbereich' readonly disabled/>
				</div>
				<div class='col-12' style='margin-top:10px'>
					<b>Ansprechpartner Fachgebiet:</b>
				</div>
				<div class='col-12'>
					<input type='text' id='ansprechpartner_fachgebiet' disabled/>
				</div>
				<div class='col-12' style='margin-top:10px'>
					<b>SCL Verantwortlicher:</b>
				</div>
				<div class='col-12'>
					<input type='text' id='scl_verantwortlicher' readonly disabled/>
				</div>
				<div class='col-12' style='margin-top:10px'>
					<b>Erwartete Anzahl Prüflinge:</b>
				</div>
				<div class='col-12'>
					<input type='text' id='erwartete_anzahl_pruflinge' readonly disabled/>
				</div>
				<hr>
					<div class='col-12' style='margin-top:10px'>
						<b>Datum:</b>
					...
					<div class='col-12'>
						<input type='text' id='datum' readonly disabled/>
    ...
    protected $editEADatePopup = "	<div id='editEADate' class='modal fade'>
		<div class='modal-dialog'>
			<div class='modal-content'>
				<form id='editEADate_form'>
					<div class='modal-header'>						
						<h4 class='modal-title'>Edit Endabnahme Date</h4>
						<button type='button' class='close' data-dismiss='modal' aria-hidden='true'>×</button>
					</div>
					<div class='modal-body'>					
						<div class='form-group'>
							<label>NAME</label>
							<input type='text' id='TerminEADate' name='TerminEADate' class='form-control' required>
						</div>
					</div>
					<div class='modal-footer'>
					    <input type='hidden' value='1' name='qmtype'>
						<input type='button' class='btn btn-default' data-dismiss='modal' value='Cancel'>
						<button type='button' class='btn btn-success' id='btneditEADate'>Update</button>
					</div>
				</form>
			</div>
		</div>
    ...
    protected $tabQMContent = "	<div id='addQMItem' class='modal fade'>
		<div class='modal-dialog'>
			<div class='modal-content'>
				<form id='QMItem_form'>
					<div class='modal-header'>						
					...
					<div class='modal-body'>					
						<div class='form-group'>
							<label>NAME</label>
							<input type='text' id='QMName' name='QMName' class='form-control' required>
							<input type='text' id='QMIdEdit' name='QMIdEdit' class='form-control' required style='display: none'>
						</div>
					</div>
					<div class='modal-footer'>
					    <input type='hidden' value='1' name='qmtype'>
						<input type='button' class='btn btn-default' data-dismiss='modal' value='Cancel'>
						<button type='button' class='btn btn-success' id='btnAddQMItem'>Add/Update</button>
					</div>
				</form>
			</div>
		</div>
    ...
    protected $tabEAContent = "	<div id='addEAItem' class='modal fade'>
		<div class='modal-dialog'>
			<div class='modal-content'>
				<form id='EAItem_form'>
					<div class='modal-header'>						
					...
					<div class='modal-body'>					
						<div class='form-group'>
							<label>NAME</label>
							<input type='text' id='EAName' name='EAName' class='form-control' required>
							<input type='text' id='EAIdEdit' name='EAIdEdit' class='form-control' required style='display: none'>
						</div>
					</div>
					<div class='modal-footer'>
					    <input type='hidden' value='1' name='eatype'>
						<input type='button' class='btn btn-default' data-dismiss='modal' value='Cancel'>
						<button type='button' class='btn btn-success' id='btnAddEAItem'>Add/Update</button>
					</div>
				</form>
			</div>
		</div>
    ...
    protected $tabTerminContent = "<div class='table-responsive'>
        <table class='table' id='topicTable'>
            <thead>
                <tr>
                    <th>Bezeichnung ℹ<br/>
                    {EDIT_DAYS_RELATED_TO_EXAM}
                    <th>Date<br/>
                    {EDIT_COLUMN_HEADER}
                </tr>
            </thead>
			...
			<div class='modal-content'>
				<form id='user_form'>
					...
					<div class='modal-body'>					
						<div class='form-group'>
							<label>NAME</label>
							<input type='text' id='topicName' name='name' class='form-control' required>
						</div>
						<div class='form-group'>
							<label>DAYS</label>
					...
					<div class='modal-footer'>
						...
						<input type='button' class='btn btn-default' data-dismiss='modal' value='Cancel'>
						<button type='button' class='btn btn-success' id='btnAddTopic'>Add/Update</button>
					</div>
				</form>
			</div>
		</div>
    ...
    <div id='editEADate' class='modal fade'>
		<div class='modal-dialog'>
			<div class='modal-content'>
				<form id='editEADate_form'>
					<div class='modal-header'>						
					...
					<div class='modal-body'>					
						<div class='form-group'>
							<label>Datum</label>
							<input type='date' id='TerminEADate' name='TerminEADate' class='form-control' required>
						</div>
					</div>
					<div class='modal-footer'>
					    <input type='hidden' value='1' name='qmtype'>
    ...
    public function __construct($cmid = 'staticonly', $userid = 0, $checklist = null, $cm = null, $course = null) {
        ...
        $PAGE->requires->js('/mod/elediachecklist/js/module.js?b=' . rand(), true);
        ...
        if ($cm) {
            ...
            $this->cm = get_coursemodule_from_id('elediachecklist', $cmid, 0, false, MUST_EXIST);
        }
        ...
        if ($checklist) {
            ...
            $this->checklist = $DB->get_record('elediachecklist', array('id' => $this->cm->instance), '*', MUST_EXIST);
        }
        ...
        $this->strchecklist = get_string('modulename', 'elediachecklist');
        $this->strchecklists = get_string('modulenameplural', 'elediachecklist');
        ...
        if (is_siteadmin() and $PAGE->user_is_editing()) {
            ...
            //if (!$PAGE->user_is_editing()) {
                $this->tabTerminContent = str_replace("{ADD_TOPIC_BUTTON}", "<a href='#addTopic' class='btn btn-success' data-toggle='modal'><i class='material-icons'></i> <span>Add Topic</span></a>", $this->tabTerminContent);
            //} else {
                $this->tabTerminContent = str_replace("{ADD_TOPIC_BUTTON}", "", $this->tabTerminContent);
            //}
        } else {
            $this->tabTerminContent = str_replace("{EDIT_DAYS_RELATED_TO_EXAM}", "", $this->tabTerminContent);
            $this->tabTerminContent = str_replace("{EDIT_COLUMN_HEADER}", "", $this->tabTerminContent);
            $this->tabTerminContent = str_replace("{ADD_TOPIC_BUTTON}", "", $this->tabTerminContent);
        }
    }
     ...
     * @return mod_elediachecklist_renderer
     */
    private static function get_renderer() {
        global $PAGE;
        return $PAGE->get_renderer('mod_elediachecklist');
    }
    ...
    protected function can_link_courses() {
        if ($this->canlinkcourses === null) {
            $this->canlinkcourses = (bool)get_config('mod_elediachecklist', 'linkcourses');
        }
    ...
    protected function canupdateown() {
        global $USER;
        return (!$this->userid || ($this->userid == $USER->id)) && has_capability('mod/elediachecklist:updateown', $this->context);
    }
    ...
    protected function canaddown() {
        ...
        && (!$this->userid || ($this->userid == $USER->id)) && has_capability('mod/elediachecklist:updateown', $this->context);
    }
    ...
    protected function canpreview() {
        return has_capability('mod/elediachecklist:preview', $this->context);
    }
    ...
    protected function canedit() {
        return has_capability('mod/elediachecklist:edit', $this->context);
    }
    ...
    protected function caneditother() {
        return has_capability('mod/elediachecklist:updateother', $this->context);
    }
    ...
    protected function canviewreports() {
        return has_capability('mod/elediachecklist:viewreports', $this->context)
        || has_capability('mod/elediachecklist:viewmenteereports', $this->context);
    }
    ...
    protected function only_view_mentee_reports() {
        return has_capability('mod/elediachecklist:viewmenteereports', $this->context)
        && !has_capability('mod/elediachecklist:viewreports', $this->context);
    }
    ...
    public function view() {
        ...
        if ((!$this->items) && $this->canedit()) {
            redirect(new moodle_url('/mod/elediachecklist/edit.php', array('id' => $this->cm->id)));
        }

        if ($this->canupdateown()) {
            $currenttab = 'view';
            //$currenttab = 'tabtermin';
        } else if ($this->canpreview()) {
            $currenttab = 'preview';
        } else {
            if ($this->canviewreports()) { // No editing, but can view reports.
                redirect(new moodle_url('/mod/elediachecklist/report.php', array('id' => $this->cm->id)));
            } else {
                $this->view_header();
        ...
        $event = \mod_elediachecklist\event\course_module_viewed::create($params);
        //$event->trigger();
    ...
    public function tabendabnahme() {
        global $OUTPUT, $CFG, $DB, $PAGE;

        $this->myExamId = optional_param('examid', 0, PARAM_INT);

        //Invoke JS to load Left panel data
        $PAGE->requires->js_init_code('loadLeftPanelData(' . $this->myExamId . ')', true);

        $currenttab = 'tabendabnahme';
        ...
        foreach ($itemList as &$item) {
            ...
            foreach ($checkedItems as &$checked) {
                if ($checked->id_item == $item->id)
                    $isChecked = "checked";
            }

            if ($item->is_checkbox == 0) {
                $checkboxTitle = "masterCB_EA" . $item->id;
                $htmlItems = $htmlItems . "<div class='form-check'><input class='form-check-input' type='checkbox' onclick='toggleSubChecks(\"ea\", \"" . $checkboxTitle . "\",  " . $this->myExamId . ", this.checked)'><label class='form-label' style='text-decoration:underline;font-weight: bold'>" . $item->displaytext . "</label></div>";
            } else {
                if (is_siteadmin() and $PAGE->user_is_editing()) {
        ...
        print "</div>";
        print "</div>";
        print $this->tabEAContent;
        $this->view_footer();

    }

    public function tabqualitats() {
        global $OUTPUT, $CFG, $DB, $PAGE;

        $currenttab = 'tabqualitats';
        ...
        foreach ($itemList as &$item) {
            ...
            if ($item->is_checkbox == 0) {
                $checkboxTitle = "masterCB_QM" . $item->id;
                $htmlItems = $htmlItems . "<div class='form-check'><input class='form-check-input' type='checkbox' onclick='toggleSubChecks(\"qm\", \"" . $checkboxTitle . "\",  " . $this->myExamId . ", this.checked)'><label class='form-label' style='text-decoration:underline;font-weight: bold'>" . $item->displaytext . "</label></div>";
            } else {
                if (is_siteadmin() and $PAGE->user_is_editing()) {
        ...
        $htmlItems = $htmlItems . "<br/><a href='#' onclick='window.open(\"export_pdf.php?examid=" . $this->myExamId . "&type=qm\")'  class='btn btn-success' data-toggle='modal'><i class='material-icons'></i> <span>Export PDF</span></a>";
        ...
        print $this->tabQMContent;
        $this->view_footer();
    }

    public function printNavigationTopButtons() {
...
// 4.1) 'Report button'.
        ...
        if (empty($myexams) == false or is_siteadmin()) {
...
// 5.) 'Prüfungstermin bearbeiten'.

        $editexamdateurl = new \moodle_url('/blocks/eledia_adminexamdates/editexamdate.php', ['editexamdate' => $this->myExamId]);
        echo $OUTPUT->single_button($editexamdateurl, get_string('editexamdate_btn', 'block_eledia_adminexamdates'), 'post');

// 6.) 'Einzeltermin planen'.

        $editsingleexamdateurl = new \moodle_url('/blocks/eledia_adminexamdates/editsingleexamdate.php', ['examdateid' => $this->myExamId]);
...
// 7.) 'Checkliste'.
        ...
        echo \html_writer::tag('button', get_string('checklist_btn', 'block_eledia_adminexamdates'), array('disabled' => true, 'class' => 'btn '));
        echo \html_writer::end_tag('div');
        ...
        // Hier kann z.b. die Checklist-HTML/Container rein.
    ...
    public function tabtermin() {
        ...
        //Invoke JS to load checked items for this exam
        $PAGE->requires->js_init_code('changeExamDateDropdown(' . $examid . ', ' . $courseid . ')', true);
        ...
        $examdate = $DB->get_record('eledia_adminexamdates', ['id' => $this->myExamId]);

        if (is_siteadmin()) {
            print "<br/><a href='#' onclick='window.open(\"export_termin_pdf.php?examid=" . $this->myExamId . "\")'  class='btn btn-success' data-toggle='modal'><i class='material-icons'></i> <span>Export PDF</span></a>";
        } else {
            if ($this->userid == $examdate->responsibleperson) {
                print "<br/><a href='#' onclick='window.open(\"export_termin_responsible_pdf.php?examid=" . $this->myExamId . "\")'  class='btn btn-success' data-toggle='modal'><i class='material-icons'></i> <span>Export PDF</span></a>";
            }
            if ($this->userid == $examdate->examiner) {
                print "<br/><a href='#' onclick='window.open(\"export_termin_examiner_pdf.php?examid=" . $this->myExamId . "\")'  class='btn btn-success' data-toggle='modal'><i class='material-icons'></i> <span>Export PDF</span></a>";
            }
        }
    ...
    public function tabeinzeltermine() {
        global $OUTPUT, $CFG, $PAGE, $DB;
    ...
    public function edit() {
        ...
        $event = \mod_elediachecklist\event\edit_page_viewed::create($params);
        //$event->trigger();
...
//        $this->view_edit_items();
    ...
    protected function view_tabs($currenttab) {
        ...
        if ($currenttab == 'tabtermin') {
            $activated[] = 'tabtermin';
            if (!$this->items) {
                $inactive = array('tabeinzeltermine', 'report', 'preview', 'tabqualitats', 'tabendabnahme', 'tabprobleme');
            }
        }

        if ($currenttab == 'tabqualitats') {
            $activated[] = 'tabqualitats';
            if (!$this->items) {
                $inactive = array('tabtermin', 'report', 'preview', 'tabendabnahme', 'tabeinzeltermine', 'tabprobleme');
            }
        }

        if ($currenttab == 'tabendabnahme') {
            $activated[] = 'tabendabnahme';
            if (!$this->items) {
                $inactive = array('tabqualitats', 'report', 'preview', 'tabtermin', 'tabeinzeltermine', 'tabprobleme');
            }
        }
        if ($currenttab == 'tabeinzeltermine') {
            $activated[] = 'tabeinzeltermine';
            if (!$this->items) {
                $inactive = array('tabqualitats', 'report', 'preview', 'tabtermin', 'tab3', 'tabprobleme');
            }
        }
        if ($currenttab == 'tabprobleme') {
            $activated[] = 'tabprobleme';
            if (!$this->items) {
                $inactive = array('tabqualitats', 'report', 'preview', 'tabtermin', 'tabeinzeltermine', 'tab4');
            }
        }
        ...
        if ($currenttab == 'edit') {
            ...
            if (!$this->items) {
                $inactive = array('view', 'report', 'preview', 'tab1', 'tab2', 'tab3', 'tab4');
            }
        }
     ...
     * @param string $currenttab
     */
    protected function view_tabs_fortschritt($currenttab) {
        $tabs = array();
        $row = array();
        $inactive = array();
        $activated = array();

        $row[] = new tabobject('tabfortschrittsliste_ansehen', new moodle_url('/mod/elediachecklist/tabtermin.php', array('id' => $this->cm->id)), 'Fortschrittsliste ansehen');
        $row[] = new tabobject('tabteilnehmerfortschritt_anzeigen', new moodle_url('/mod/elediachecklist/report.php', array('id' => $this->cm->id)), 'Teilnehmerfortschritt anzeigen');
        $row[] = new tabobject('tabfortschrittsliste_bearbeiten', new moodle_url('/mod/elediachecklist/edit.php', array('id' => $this->cm->id)), 'Fortschrittsliste bearbeiten');
        ...
        if ($currenttab == 'tabfortschrittsliste_ansehen') {
            $activated[] = 'tabfortschrittsliste_ansehen';
            if (!$this->items) {
                $inactive = array('tabteilnehmerfortschritt_anzeigen', tabfortschrittsliste_bearbeiten);
            }
        }

        if ($currenttab == 'tabteilnehmerfortschritt_anzeigen') {
            $activated[] = 'tabteilnehmerfortschritt_anzeigen';
            if (!$this->items) {
                $inactive = array('tabfortschrittsliste_ansehen', tabfortschrittsliste_bearbeiten);
            }
        }

        if ($currenttab == 'tabfortschrittsliste_bearbeiten') {
            $activated[] = 'tabfortschrittsliste_bearbeiten';
            if (!$this->items) {
                $inactive = array('tabfortschrittsliste_ansehen', 'tabteilnehmerfortschritt_anzeigen');
            }
        }
     ...
     * @return \mod_elediachecklist\local\progress_info|null
     */
    protected function get_progress() {
        ...
        return new \mod_elediachecklist\local\progress_info($totalitems, $requireditems, $allcompleteitems, $completeitems);
    }
    ...
    protected function view_items($viewother = false, $userreport = false) {
        ...
        if ($status->is_showteachermark() && $status->is_viewother() && $this->checklist->lockteachermarks) {
            $status->set_teachermarklocked(!has_capability('mod/elediachecklist:updatelocked', $this->context));
        }
        if ($status->is_viewother()) {
        ...
        if (!$status->is_viewother()) {
            ...
            $jsmodule = array(
                'name' => 'mod_elediachecklist',
                'fullpath' => new moodle_url('/mod/elediachecklist/updatechecks24.js')
            );
            $updatechecksurl = new moodle_url('/mod/elediachecklist/updatechecks.php');
            // Progress bars should be updated on 'student only' checklists.
            $updateprogress = $status->is_showteachermark() ? 0 : 1;
            $PAGE->requires->js_init_call('M.mod_elediachecklist.init', array(
    ...
    protected function view_report() {
        ...
        $thisurl = new moodle_url('/mod/elediachecklist/report.php', array('id' => $this->cm->id, 'sesskey' => sesskey()));
        if ($editchecks) {
        ...
        if ($activegroup == -1) {
            ...
            if (get_config('mod_elediachecklist', 'onlyenrolled')) {
                $users = get_enrolled_users($this->context, 'mod/elediachecklist:updateown', $activegroup, 'u.id', $orderby, 0, 0, true);
            } else {
                $users = get_users_by_capability($this->context, 'mod/elediachecklist:updateown', 'u.id', $orderby, '', '',
                                                 $activegroup, '', false);
            }
            if ($users) {
    ...
    protected function report_add_toggle_button_row($table) {
        ...
        $PAGE->requires->yui_module('moodle-mod_elediachecklist-buttons', 'M.mod_elediachecklist.buttons.init');
    ...
    protected function process_view_actions() {
        ...
        switch ($action) {
            ...
            default:
                throw new moodle_exception('invalidaction', 'mod_elediachecklist', '', $action);
        }
    ...
    protected function setevent(checklist_item $item, $add) {
        ...
        if ((!$add) || ($item->duetime == 0)) {  // Remove the event (if any).
            ...
            $eventdata->description = get_string('calendardescription', 'elediachecklist', $this->checklist->name);
    ...
    protected function updatechecks($newchecks) {
        ...
        $event = \mod_elediachecklist\event\student_checks_updated::create($params);
        //$event->trigger();
    ...
    protected function updateteachermarks() {
        ...
        if ($this->checklist->teacheredit != CHECKLIST_MARKING_STUDENT) {
            ...
            $event = \mod_elediachecklist\event\teacher_checks_updated::create($params);
            //$event->trigger();

            $teachermarklocked = $this->checklist->lockteachermarks
                && !has_capability('mod/elediachecklist:updatelocked', $this->context);
    ...
    public function update_all_autoupdate_checks($updmodules = true, $updcourses = true) {
        ...
        if (get_config('mod_elediachecklist', 'onlyenrolled')) {
            $users = get_enrolled_users($this->context, 'mod/elediachecklist:updateown', 0, 'u.id', null, 0, 0, true);
        } else {
            $users = get_users_by_capability($this->context, 'mod/elediachecklist:updateown', 'u.id', '', '', '', '', '', false);
        }
        if (!$users) {
            return;
        }
        ...
        WHERE m.id = cm.module AND cm.id = i.moduleid AND i.moduleid > 0 AND i.checklist = ? AND i.itemoptional != 2";
            ...
            foreach ($items as $item) {
                ...
                $loguserids = mod_elediachecklist\local\autoupdate::get_logged_userids($item->mod_name, $item->cmid, $userids);
                if (!$loguserids) {
                    continue;
                }
    ...
    protected function getnextuserid() {
        ...
        $ausers = [];
        if (get_config('mod_elediachecklist', 'onlyenrolled')) {
            $users = get_enrolled_users($this->context, 'mod/elediachecklist:updateown', $activegroup, 'u.id', null, 0, 0, true);
        } else {
            $users = get_users_by_capability($this->context, 'mod/elediachecklist:updateown', 'u.id', '', '', '',
                                             $activegroup, '', false);
        }
        if ($users) {
            $users = array_keys($users);
    ...
    public static function get_user_progress($checklistid, $userid) {
        ...
        $checklist = $DB->get_record('elediachecklist', array('id' => $checklistid));
        if (!$checklist) {
