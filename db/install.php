 ...
 */
function xmldb_elediachecklist_install() {
    global $CFG, $DB;
    ...
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (16, 'Klausurrechner alle (!) hochgefahren', 1, 'qm')", null);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (17, ?, 1, 'qm')", ['Prüfen: Lüftung funktioniert?, Willkommensbildschirm aktiviert']);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (18, 'Prüfungskurs in Aktuelle Klausuren verschieben', 1, 'qm')", null);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (19, 'Kurs sichtbar schalten', 1, 'qm')", null);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (20, 'Testeinstellungen: Gruppenvoraussetzungen festlegen', 1, 'qm')", null);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (21, 'Test sichtbar -> Testlauf -> Test unsichtbar, Testversuche löschen', 1, 'qm')", null);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (22, 'Eingabegeräte freischalten', 1, 'qm')", null);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (23, 'Checkpunkte bei jeder Gruppe', 0, 'qm')", null);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (24, ?, 1, 'qm')", ['Prüfen: Etiketten liegen bereit?']);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (25, 'Eingabegeräte deaktivieren', 1, 'qm')", null);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (26, 'Eingabegeräte freischalten', 1, 'qm')", null);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (27, 'Nachteilsausgleiche nach TN-Login einrichten', 1, 'qm')", null);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (28, 'Test sichtbar schalten', 1, 'qm')", null);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (29, 'Teilnehmerzahlen im Formular eingetragen, TN-Liste erstellen mit TN-Zahl abgleichen', 1, 'qm')", null);
    $DB->execute("INSERT INTO {elediachecklist_my_item} VALUES (30, ?, 1, 'qm')", ['Prüfen: Alles abgesendet (?) in Logodidact prüfen, Ergebnisse in Bewertungsübersicht vorhanden? Anzahl abgleichen']);
    ...
    */
    ...
    $DB->execute("INSERT INTO {elediachecklist_item} VALUES (5, 1, 0, 'Funktionstest der Klausur durchgeführt', 5, 0, 0, -8, 0, 'black', 0, 0, 0, NULL, '', 0, 'Funktionstest der Klausur durchgeführt {Datum}')", null);
    $DB->execute("INSERT INTO {elediachecklist_item} VALUES (6, 1, 0, 'Qualitätskontrolle durchgeführt', 6, 0, 0, -7, 0, 'red', 0, 0, 0, NULL, '', 0, 'Qualitätskontrolle durchgeführt {Datum}')", null);
    $DB->execute("INSERT INTO {elediachecklist_item} VALUES (7, 1, 0, 'Endabnahme', 7, 0, 0, -5, 0, 'black', 0, 0, 0, NULL, '', 0, 'Endabnahme {Datum}')", null);
    $DB->execute("INSERT INTO {elediachecklist_item} VALUES (8, 1, 0, 'HIS-Liste an E-Klausur-Team', 8, 0, 0, -5, 0, 'black', 0, 0, 0, NULL, '', 0, 'HIS-Liste an E-Klausur-Team {Datum}')", null);
    $DB->execute("INSERT INTO {elediachecklist_item} VALUES (9, 1, 0, 'Gruppeneinteilung abgeschlossen', 9, 0, 0, -4, 0, 'black', 0, 0, 0, NULL, '', 0, 'Gruppeneinteilung abgeschlossen {Datum}')", null);
    $DB->execute("INSERT INTO {elediachecklist_item} VALUES (10, 1, 0, 'Namen der Aufsichtspersonen', 10, 0, 0, -3, 0, 'black', 0, 0, 0, NULL, '', 0, 'Namen der Aufsichtspersonen {Datum}')", null);
    $DB->execute("INSERT INTO {elediachecklist_item} VALUES (11, 1, 0, 'Importlisten vorbereitet', 11, 0, 0, -1, 0, 'black', 0, 0, 0, NULL, '', 0, 'Importlisten vorbereitet {Datum}')", null);
    $DB->execute("INSERT INTO {elediachecklist_item} VALUES (12, 1, 0, 'TN-Import und Etikettenerstellungexam date', 12, 0, 0, 0, 0, 'black', 0, 0, 0, NULL, '', 0, 'TN-Import und Etikettenerstellungexam date {Datum}')", null);
    $DB->execute("INSERT INTO {elediachecklist_item} VALUES (13, 1, 0, 'Problemfälle bearbeitet', 13, 0, 0, 2, 0, 'black', 0, 0, 0, NULL, '', 0, 'Problemfälle bearbeitet {Datum}')", null);
    $DB->execute("INSERT INTO {elediachecklist_item} VALUES (15, 1, 0, 'Mitteilung über abgeschlossene Klausureinsicht', 14, 0, 0, 100, 0, 'black', 0, 0, 0, NULL, '', 0, 'Mitteilung über abgeschlossene Klausureinsicht {Datum}')", null);
