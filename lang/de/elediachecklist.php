...
$string['Es_wird_vom_Fachgebiet'] =
        'Es wird vom Fachgebiet bestätigt, dass der Funktionstest durchgeführt und die rechtlichen Vorgaben zur Durchführung dieser E-Klausur beachtet wurden';
...
$string['erinnerung_kvb_beschreibung'] =
        'Wählen Sie die Punkte aus der Termincheckliste aus, ' . 'die in der E-Mail aufgeführt werden sollen.';
...
$string['kein_scl_verantwortlicher_genannt'] =
        'Es ist kein E-Assessment Center-Verantwortlicher genannt. Es wurde keine E-Mail versendet.';
...
$string['elediachecklist:emailoncomplete'] =
        'Nutzer erhält eine E-Mail wenn die Checkliste abgeschlossen ist (wenn in der Checkliste aktiviert).';
$string['elediachecklist:preview'] = 'Berechtigung zur Vorschau einer Checkliste.';
$string['elediachecklist:updatelocked'] =
        'Kann Checkliste einer Lehrperson aktualisieren, selbst wenn sie als gesperrt markiert ist.';
