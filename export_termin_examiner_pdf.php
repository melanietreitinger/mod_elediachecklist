...
$examTopics = $DB->get_records_sql("SELECT * FROM {".$tab."} WHERE id IN (3,5,8,9,10,15,17)");
...
$pdf->Cell(100, 12, iconv('UTF-8', 'windows-1252',  "Datum"), 1, 0, 'C', false, '', 2);
...
foreach ($examTopics as &$topic) {
    ...
    $pdf->Cell(100, 12, iconv('UTF-8', 'windows-1252',  date('d.m.Y', strtotime($topic->duetime . ' day', strtotime($topicDate )))), 1, 0, 'C', false, '', 2);
}
